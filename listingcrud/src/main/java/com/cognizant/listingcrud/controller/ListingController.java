...
public class ListingController {
    ...
    public ResponseEntity<Listing> createListing(@RequestBody LinkedHashMap<String, String> body){
        ...
        return new ResponseEntity<>(ls.createListing(body.get("title"),body.get("address"),body.get("type"),lId, body.get("image"), p, guest, caps, Double.parseDouble(body.get("rating")),Integer.parseInt(body.get("userId")), Boolean.parseBoolean(body.get("isTrending"))  ), HttpStatus.ACCEPTED);
    }
}
